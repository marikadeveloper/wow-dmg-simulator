    ...
    <button
      ...
      className={[
        ...
        isSelected
          ...
          : 'bg-zinc-800/40 text-zinc-500 border border-zinc-700/30 hover:text-zinc-400 hover:border-zinc-600/40',
      ].join(' ')}
    >
    ...
    <div className="flex items-center justify-between gap-3 py-1.5">
      ...
      <div className="flex items-center gap-2 min-w-0">
        <div className="min-w-0">
          <div className="text-[11px] text-zinc-300 truncate" title={definition.name}>
            {definition.name}
          </div>
...
export default function TierSetFilter({
  ...
  return (
    <div className="rounded-lg border border-zinc-800/60 bg-zinc-900/50 overflow-hidden">
      {/* Header */}
      <div className="px-3.5 py-2 border-b border-zinc-800/40 flex items-center justify-between">
