...
export interface RaidEncounter {
  ...
  name: string;
  /** Wowhead NPC ID for boss portrait (creature ID from wowhead.com/npc/{npcId}). */
  npcId?: number;
...
export const RAID_INSTANCES: RaidInstance[] = [
  ...
  // Boss assignments verified against warcraft.wiki.gg loot pages (2026-04-04).
  {
    id: 'the_voidspire',
    name: 'The Voidspire',
    encounters: [
      // Source: https://warcraft.wiki.gg/wiki/Imperator_Averzian#Loot
      {
        id: 'imperator_averzian',
        name: 'Imperator Averzian',
        npcId: 240435,
        portraitSlug: 'host-general',
        bossTier: 1,
        items: [
          { itemId: 249275, name: 'Bulwark of Noble Resolve', slot: 'off_hand' },
          { itemId: 249279, name: 'Sunstrike Rifle', slot: 'main_hand' },
      ...
      // Source: https://warcraft.wiki.gg/wiki/Vorasius#Loot
      {
        id: 'vorasius',
        name: 'Vorasius',
        npcId: 240434,
      ...
      // Source: https://warcraft.wiki.gg/wiki/Fallen-King_Salhadaar#Loot
      {
        id: 'fallen_king_salhadaar',
        name: 'Fallen-King Salhadaar',
        npcId: 240432,
        portraitSlug: 'salhadaar',
        bossTier: 2,
        items: [
      ...
      // Source: https://warcraft.wiki.gg/wiki/Vaelgor_%26_Ezzorak#Loot
      {
        id: 'vaelgor_and_ezzorak',
        name: 'Vaelgor & Ezzorak',
        npcId: 242056,
        portraitSlug: 'dragon-duo',
        bossTier: 3,
        items: [
      ...
      // Source: https://warcraft.wiki.gg/wiki/Lightblinded_Vanguard#Loot
      {
        id: 'lightblinded_vanguard',
        name: 'Lightblinded Vanguard',
        npcId: 250589,
        portraitSlug: 'paladin-trio',
        bossTier: 3,
        items: [
          { itemId: 249277, name: "Bellamy's Final Judgement", slot: 'main_hand' },
      ...
      // Source: https://warcraft.wiki.gg/wiki/Crown_of_the_Cosmos_(boss)#Loot
      {
        id: 'crown_of_the_cosmos',
        name: 'Crown of the Cosmos',
        npcId: 244761,
        portraitSlug: 'alleria',
        bossTier: 4,
        items: [
          { itemId: 249288, name: "Ranger-Captain's Lethal Recurve", slot: 'main_hand' },
  ...
  // ── March on Quel'Danas (2 bosses) ────────────────────────────────────────
  {
    ...
    encounters: [
      // Source: https://warcraft.wiki.gg/wiki/Belo%27ren,_Child_of_Al%27ar#Loot
      {
        ...
        npcId: 240387,
        portraitSlug: 'light-void-phoenix',
        bossTier: 4,
        items: [
    ...
    encounters: [
      {
        ...
        npcId: 256116,
        portraitSlug: 'malformed-manifestation',
        bossTier: 2,
        items: [
...
export const MYTHIC_PLUS_DUNGEONS: MplusDungeon[] = [
  ...
  // ── Magisters' Terrace ────────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      { itemId: 251102, name: 'Clasp of Compliance', slot: 'waist', armorType: 'cloth' },
      { itemId: 251103, name: 'Custodial Cuffs', slot: 'wrist', armorType: 'leather' },
      { itemId: 251104, name: 'Leggings of Orderly Conduct', slot: 'legs', armorType: 'mail' },
      ...
      { itemId: 251110, name: "Sunlash's Sunsash", slot: 'waist', armorType: 'mail' },
      { itemId: 251111, name: 'Splitshroud Stinger', slot: 'main_hand' },
      { itemId: 251112, name: 'Shadowsplit Girdle', slot: 'waist', armorType: 'plate' },
      { itemId: 251113, name: 'Gloves of Viscous Goo', slot: 'hands', armorType: 'leather' },
  ...
  // ── Nexus-Point Xenas ─────────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      { itemId: 251203, name: "Kasreth's Bindings", slot: 'wrist', armorType: 'plate' },
      ...
      { itemId: 251210, name: 'Eclipse Espadrilles', slot: 'feet', armorType: 'leather' },
      { itemId: 251211, name: 'Fractured Fingerguards', slot: 'hands', armorType: 'cloth' },
      { itemId: 251212, name: 'Radiant Slicer', slot: 'main_hand' },
      { itemId: 251213, name: "Nysarra's Mantle", slot: 'shoulder', armorType: 'cloth' },
      { itemId: 251217, name: 'Occlusion of Void', slot: 'finger' },
      { itemId: 251218, name: "Taz'Rah's Cosmic Edge", slot: 'main_hand' },
      { itemId: 251219, name: 'Riftworn Stompers', slot: 'feet', armorType: 'cloth' },
  ...
  // ── Seat of the Triumvirate ───────────────────────────────────────────────
  {
    ...
    items: [
      ...
      { itemId: 152001, name: "Nexus Conductor's Headgear", slot: 'head', armorType: 'mail' },
      { itemId: 152002, name: 'Battalion-Shattering Leggings', slot: 'legs', armorType: 'mail' },
      { itemId: 152003, name: 'Legguards of Numbing Gloom', slot: 'legs', armorType: 'mail' },
      { itemId: 152004, name: 'Pauldrons of the Soulburner', slot: 'shoulder', armorType: 'mail' },
      { itemId: 152005, name: 'Pauldrons of Colossal Burden', slot: 'shoulder', armorType: 'mail' },
      { itemId: 152006, name: "Depraved Tactician's Waistguard", slot: 'waist', armorType: 'mail' },
      { itemId: 152007, name: 'Sash of the Gilded Rose', slot: 'waist', armorType: 'mail' },
      { itemId: 152008, name: 'Reality-Splitting Wristguards', slot: 'wrist', armorType: 'mail' },
      { itemId: 152009, name: 'Doomwalker Warboots', slot: 'feet', armorType: 'plate' },
      { itemId: 152010, name: 'Burning Coven Sabatons', slot: 'feet', armorType: 'plate' },
      { itemId: 152012, name: 'Molten Bite Handguards', slot: 'hands', armorType: 'plate' },
  ...
  // ── Pit of Saron ──────────────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      { itemId: 50208, name: 'Pauldrons of the Souleater', slot: 'shoulder', armorType: 'plate' },
      { itemId: 50209, name: 'Essence of Suffering', slot: 'wrist', armorType: 'mail' },
      ...
      { itemId: 50229, name: 'Legguards of the Frosty Depths', slot: 'legs', armorType: 'plate' },
      { itemId: 50230, name: 'Malykriss Vambraces', slot: 'wrist', armorType: 'plate' },
      { itemId: 50233, name: "Spurned Val'kyr Shoulderguards", slot: 'shoulder', armorType: 'mail' },
  ...
  // ── Maisara Caverns ───────────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      { itemId: 251176, name: "Reanimator's Weight", slot: 'shoulder', armorType: 'mail' },
      { itemId: 251177, name: 'Fetid Vilecrown', slot: 'head', armorType: 'leather' },
      { itemId: 251178, name: 'Ceremonial Hexblade', slot: 'main_hand' },
      { itemId: 251179, name: 'Decaying Cuirass', slot: 'chest', armorType: 'mail' },
      { itemId: 251180, name: 'Thornblade', slot: 'main_hand' },
      { itemId: 251181, name: 'Pruning Lance', slot: 'main_hand' },
      { itemId: 251182, name: 'Bedrock Breeches', slot: 'legs', armorType: 'plate' },
      { itemId: 251183, name: 'Rootwarden Wraps', slot: 'wrist', armorType: 'leather' },
      { itemId: 251184, name: 'Ironroot Collar', slot: 'shoulder', armorType: 'mail' },
      { itemId: 251185, name: 'Lightblossom Cinch', slot: 'waist', armorType: 'cloth' },
      { itemId: 251186, name: 'Thorntalon Edge', slot: 'main_hand' },
      { itemId: 251189, name: 'Rootwalker Harness', slot: 'waist', armorType: 'leather' },
      ...
      { itemId: 251199, name: 'Worldroot Canopy', slot: 'head', armorType: 'cloth' },
    ],
  },
  ...
  // ── Skyreach ──────────────────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      { itemId: 251144, name: "Autumn's Boon Belt", slot: 'waist', armorType: 'plate' },
      { itemId: 251145, name: 'Forgotten Tribe Footguards', slot: 'feet', armorType: 'mail' },
      { itemId: 251146, name: "Scavenger's Spaulders", slot: 'shoulder', armorType: 'leather' },
      { itemId: 251147, name: 'Hoarded Harvest Wrap', slot: 'chest', armorType: 'cloth' },
      ...
      { itemId: 251153, name: "Arctic Explorer's Legwraps", slot: 'feet', armorType: 'leather' },
      { itemId: 251154, name: "Winter's Embrace Bracers", slot: 'wrist', armorType: 'cloth' },
      { itemId: 251155, name: "Tribal Defender's Cord", slot: 'waist', armorType: 'mail' },
  ...
  // ── Windrunner Spire ──────────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      { itemId: 251119, name: 'Vortex Visage', slot: 'head', armorType: 'mail' },
      ...
      { itemId: 251124, name: 'Gauntlets of Fevered Defense', slot: 'hands', armorType: 'leather' },
      { itemId: 251125, name: 'Felsoaked Soles', slot: 'feet', armorType: 'mail' },
      { itemId: 251126, name: 'Greathelm of Temptation', slot: 'head', armorType: 'plate' },
      { itemId: 251127, name: 'Nibbling Armbands', slot: 'wrist', armorType: 'cloth' },
      ...
      { itemId: 251131, name: 'Jangling Felpaulets', slot: 'shoulder', armorType: 'mail' },
...
export const WORLD_BOSSES: WorldBoss[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { itemId: 250457, name: "Devouring Outrider's Chausses", slot: 'legs', armorType: 'leather' },
      { itemId: 250458, name: "Host Commander's Casque", slot: 'head', armorType: 'plate' },
      { itemId: 250459, name: "Bramblestalker's Feathered Cowl", slot: 'head', armorType: 'mail' },
